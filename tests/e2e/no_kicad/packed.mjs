...
try {
  ...
  const cli = join(temporary, "node_modules", "@easyeda-copilot", "router", "package-dist", "cli.js")
  ...
  const adapterPath = join(temporary, "node_modules", "@easyeda-copilot", "router", "package-dist", "adapters", "kicad.js")
